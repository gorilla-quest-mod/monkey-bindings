...
namespace Cinemachine {
  ...
  // [DocumentationSortingAttribute] Offset: AE6670
  class CinemachinePathBase::Appearance : public ::Il2CppObject {
    public:
    public:
    // [TooltipAttribute] Offset: 0xAECAE0
    ...
    // [TooltipAttribute] Offset: 0xAECB18
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Color) == 0x10);
    // [TooltipAttribute] Offset: 0xAECB50
    // [RangeAttribute] Offset: 0xAECB50
