...
namespace Cinemachine {
  ...
  // [DocumentationSortingAttribute] Offset: AE6274
  // [HelpURLAttribute] Offset: AE6274
  class CinemachineFixedSignal : public ::Cinemachine::SignalSourceAsset {
    public:
    public:
    // [TooltipAttribute] Offset: 0xAEBD68
    ...
    // [TooltipAttribute] Offset: 0xAEBDA0
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::AnimationCurve*) == 0x8);
    // [TooltipAttribute] Offset: 0xAEBDD8
