...
namespace Cinemachine {
  ...
  class CinemachineVirtualCameraBase : public ::UnityEngine::MonoBehaviour/*, public ::Cinemachine::ICinemachineCamera*/ {
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [TooltipAttribute] Offset: 0xAEB4A0
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xAEB4EC
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAEB4FC
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xAEB50C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAEB544
