...
namespace Cinemachine {
  ...
  // [AddComponentMenu] Offset: AE4F7C
  // [ExecuteAlways] Offset: FFFFFFFF
  // [DisallowMultipleComponent] Offset: FFFFFFFF
  class Cinemachine3rdPersonAim : public ::Cinemachine::CinemachineExtension {
    public:
    public:
    // [HeaderAttribute] Offset: 0xAE6A28
    // [TooltipAttribute] Offset: 0xAE6A28
    ...
    char __padding0[0x4] = {};
    // [TooltipAttribute] Offset: 0xAE6A88
    ...
    // [TooltipAttribute] Offset: 0xAE6AD4
    ...
    char __padding2[0x4] = {};
    // [TooltipAttribute] Offset: 0xAE6B0C
