...
namespace Mono::Security::Interface {
  ...
  class CertificateValidationHelper : public ::Il2CppObject {
    ...
    // Offset: 0x16D5218
    static void _cctor();
    // static public System.Boolean get_SupportsX509Chain()
    // Offset: 0x16D528C
    static bool get_SupportsX509Chain();
...
// Writing MetadataGetter for method: Mono::Security::Interface::CertificateValidationHelper::get_SupportsX509Chain
// Il2CppName: get_SupportsX509Chain
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)()>(&Mono::Security::Interface::CertificateValidationHelper::get_SupportsX509Chain)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::Interface::CertificateValidationHelper*), "get_SupportsX509Chain", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
