...
namespace ExitGames::Client::Photon {
  ...
  class NetworkSimulationSet : public ::Il2CppObject {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAAC4CC
    // [DebuggerBrowsableAttribute] Offset: 0xAAC4CC
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [DebuggerBrowsableAttribute] Offset: 0xAAC508
    // [CompilerGeneratedAttribute] Offset: 0xAAC508
