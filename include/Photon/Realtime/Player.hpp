...
namespace Photon::Realtime {
  ...
  class Player : public ::Il2CppObject {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xAAE6A0
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAAE6B0
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAAE6C0
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [CompilerGeneratedAttribute] Offset: 0xAAE6D0
    ...
    char __padding6[0x7] = {};
    // [CompilerGeneratedAttribute] Offset: 0xAAE6E0
