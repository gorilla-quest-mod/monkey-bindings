...
namespace Photon::Voice::Unity::UtilityScripts {
  ...
  class MicAmplifierShort : public ::Il2CppObject/*, public ::Photon::Voice::IProcessor_1<int16_t>*/ {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xAB602C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAB603C
    ...
    // Field size check
    static_assert(sizeof(int16_t) == 0x2);
    // [CompilerGeneratedAttribute] Offset: 0xAB604C
    ...
    // Field size check
    static_assert(sizeof(int16_t) == 0x2);
    // [CompilerGeneratedAttribute] Offset: 0xAB605C
    ...
    // Field size check
    static_assert(sizeof(int16_t) == 0x2);
    // [CompilerGeneratedAttribute] Offset: 0xAB606C
