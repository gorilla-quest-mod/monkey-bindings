...
namespace Photon::Voice {
  ...
  // Autogenerated type: Photon.Voice.VoiceClient/<>c__DisplayClass49_0`1
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: AAF350
  template<typename T>
  ...
  }; // Photon.Voice.VoiceClient/<>c__DisplayClass49_0`1
  // Could not write size check! Type: Photon.Voice.VoiceClient/<>c__DisplayClass49_0`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
