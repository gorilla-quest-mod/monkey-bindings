...
namespace Photon::Voice {
  ...
  class AudioOutDelayControl::PlayDelayConfig : public ::Il2CppObject {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xAAF870
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAAF880
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xAAF890
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xAAF8A0
