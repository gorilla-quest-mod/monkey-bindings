...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: A6893C
  // [NativeHeaderAttribute] Offset: A6893C
  class Display : public ::Il2CppObject {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xA6D088
    // [DebuggerBrowsableAttribute] Offset: 0xA6D088
