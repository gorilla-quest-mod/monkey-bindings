...
namespace UnityEngine::InputSystem::Controls {
  ...
  class QuaternionControl : public ::UnityEngine::InputSystem::InputControl_1<::UnityEngine::Quaternion> {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xAC0B34
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAC0B44
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::InputSystem::Controls::AxisControl*) == 0x8);
    // [CompilerGeneratedAttribute] Offset: 0xAC0B54
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::InputSystem::Controls::AxisControl*) == 0x8);
    // [CompilerGeneratedAttribute] Offset: 0xAC0B64
