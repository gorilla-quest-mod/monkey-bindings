...
namespace UnityEngine::InputSystem::Controls {
  ...
  class StickControl : public ::UnityEngine::InputSystem::Controls::Vector2Control {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xAC0B74
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAC0B84
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::InputSystem::Controls::ButtonControl*) == 0x8);
    // [CompilerGeneratedAttribute] Offset: 0xAC0B94
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::InputSystem::Controls::ButtonControl*) == 0x8);
    // [CompilerGeneratedAttribute] Offset: 0xAC0BA4
