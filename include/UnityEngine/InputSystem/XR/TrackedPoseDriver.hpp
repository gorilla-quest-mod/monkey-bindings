...
namespace UnityEngine::InputSystem::XR {
  ...
  // [AddComponentMenu] Offset: AB7D68
  class TrackedPoseDriver : public ::UnityEngine::MonoBehaviour {
    ...
    // Offset: 0x1AA28C8
    void UnbindRotation();
    // private System.Void OnPositionUpdate(UnityEngine.InputSystem.InputAction/CallbackContext context)
    // Offset: 0x1AA2BB0
    void OnPositionUpdate(::UnityEngine::InputSystem::InputAction_CallbackContext context);
    // private System.Void OnRotationUpdate(UnityEngine.InputSystem.InputAction/CallbackContext context)
    // Offset: 0x1AA2C18
