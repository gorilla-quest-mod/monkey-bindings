...
namespace UnityEngine::InputSystem::Composites {
  ...
  // [DisplayStringFormatAttribute] Offset: AB8F80
  class AxisComposite : public ::UnityEngine::InputSystem::InputBindingComposite_1<float> {
    ...
    public:
    // [InputControlAttribute] Offset: 0xAC0E2C
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [InputControlAttribute] Offset: 0xAC0E68
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [TooltipAttribute] Offset: 0xAC0EA4
    ...
    // [TooltipAttribute] Offset: 0xAC0EDC
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xAC0F14
