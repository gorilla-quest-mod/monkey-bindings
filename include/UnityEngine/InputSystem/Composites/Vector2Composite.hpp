...
namespace UnityEngine::InputSystem::Composites {
  ...
  // [DisplayStringFormatAttribute] Offset: AB9064
  class Vector2Composite : public ::UnityEngine::InputSystem::InputBindingComposite_1<::UnityEngine::Vector2> {
    ...
    public:
    // [InputControlAttribute] Offset: 0xAC1078
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [InputControlAttribute] Offset: 0xAC10B4
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [InputControlAttribute] Offset: 0xAC10F0
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [InputControlAttribute] Offset: 0xAC112C
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [ObsoleteAttribute] Offset: 0xAC1168
