...
namespace UnityEngine::InputSystem::Utilities {
  ...
  // [DefaultMemberAttribute] Offset: AB8EE0
  template<typename TValue>
  struct ReadOnlyArray_1/*, public ::System::ValueType, public ::System::Collections::Generic::IReadOnlyList_1<TValue>*/ {
    ...
    class Enumerator_1;
    // WARNING Size may be invalid!
    // Autogenerated type: UnityEngine.InputSystem.Utilities.ReadOnlyArray`1/Enumerator`1
    // [TokenAttribute] Offset: FFFFFFFF
    template<typename T>
    ...
    }; // UnityEngine.InputSystem.Utilities.ReadOnlyArray`1/Enumerator`1
    // Could not write size check! Type: UnityEngine.InputSystem.Utilities.ReadOnlyArray`1/Enumerator`1 is generic, or has no fields that are valid for size checks!
    public:
    // TValue[] m_Array
    // Size: 0x8
    // Offset: 0x0
