...
namespace UnityEngine::UIElements {
  ...
  class RepaintData : public ::Il2CppObject {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xA9FFE4
    // [DebuggerBrowsableAttribute] Offset: 0xA9FFE4
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xAA0020
    // [CompilerGeneratedAttribute] Offset: 0xAA0020
