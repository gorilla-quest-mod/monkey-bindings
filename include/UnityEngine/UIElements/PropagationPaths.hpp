...
namespace UnityEngine::UIElements {
  ...
  class PropagationPaths : public ::Il2CppObject {
    ...
    // Offset: 0xD426EC
    static ::UnityEngine::UIElements::PropagationPaths* Copy(::UnityEngine::UIElements::PropagationPaths* paths);
    // static public UnityEngine.UIElements.PropagationPaths Build(UnityEngine.UIElements.VisualElement elem, UnityEngine.UIElements.PropagationPaths/Type pathTypesRequested)
    // Offset: 0xD42450
