...
namespace UnityEngine {
  ...
  struct TerrainData::BoundaryValueType/*, public ::System::Enum*/ {
    ...
    // static field const value: static public UnityEngine.TerrainData/BoundaryValueType MaxDetailsPerRes
    static constexpr const int MaxDetailsPerRes = 4;
    // Get static field: static public UnityEngine.TerrainData/BoundaryValueType MaxDetailsPerRes
    static ::UnityEngine::TerrainData::BoundaryValueType _get_MaxDetailsPerRes();
    // Set static field: static public UnityEngine.TerrainData/BoundaryValueType MaxDetailsPerRes
