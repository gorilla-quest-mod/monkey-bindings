...
namespace UnityEngine {
  ...
  // [NativeTypeAttribute] Offset: A7BF54
  class SubsystemManager : public ::Il2CppObject {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xA7C050
    // [CompilerGeneratedAttribute] Offset: 0xA7C050
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xA7C08C
    // [CompilerGeneratedAttribute] Offset: 0xA7C08C
