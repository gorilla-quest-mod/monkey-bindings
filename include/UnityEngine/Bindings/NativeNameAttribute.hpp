...
namespace UnityEngine::Bindings {
  ...
  // [VisibleToOtherModulesAttribute] Offset: A65AFC
  // [AttributeUsageAttribute] Offset: A65AFC
  class NativeNameAttribute : public ::System::Attribute {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xA6607C
    // [DebuggerBrowsableAttribute] Offset: 0xA6607C
