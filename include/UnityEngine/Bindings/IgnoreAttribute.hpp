...
namespace UnityEngine::Bindings {
  ...
  // [VisibleToOtherModulesAttribute] Offset: A65DFC
  // [AttributeUsageAttribute] Offset: A65DFC
  class IgnoreAttribute : public ::System::Attribute {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xA663C4
    // [DebuggerBrowsableAttribute] Offset: 0xA663C4
