...
namespace UnityEngine::Bindings {
  ...
  // [VisibleToOtherModulesAttribute] Offset: A65B38
  // [AttributeUsageAttribute] Offset: A65B38
  class NativeWritableSelfAttribute : public ::System::Attribute {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xA660B8
    // [CompilerGeneratedAttribute] Offset: 0xA660B8
