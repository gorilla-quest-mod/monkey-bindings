...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: A65BC0
  // [VisibleToOtherModulesAttribute] Offset: A65BC0
  class NativePropertyAttribute : public ::UnityEngine::Bindings::NativeMethodAttribute {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xA66220
    // [CompilerGeneratedAttribute] Offset: 0xA66220
