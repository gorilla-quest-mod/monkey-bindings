...
namespace UnityEngine::Scripting {
  ...
  // [VisibleToOtherModulesAttribute] Offset: A65E38
  // [AttributeUsageAttribute] Offset: A65E38
  class UsedByNativeCodeAttribute : public ::System::Attribute {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xA66400
    // [DebuggerBrowsableAttribute] Offset: 0xA66400
