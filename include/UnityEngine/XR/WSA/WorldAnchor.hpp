...
namespace UnityEngine::XR::WSA {
  ...
  // [MovedFromAttribute] Offset: AA8DCC
  // [RequireComponent] Offset: AA8DCC
  // [NativeHeaderAttribute] Offset: AA8DCC
  // [UsedByNativeCodeAttribute] Offset: AA8DCC
  class WorldAnchor : public ::UnityEngine::Component {
    ...
    public:
    // [CompilerGeneratedAttribute] Offset: 0xAA8EC4
    // [DebuggerBrowsableAttribute] Offset: 0xAA8EC4
