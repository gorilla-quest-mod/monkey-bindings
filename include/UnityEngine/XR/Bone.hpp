...
namespace UnityEngine::XR {
  ...
  // [RequiredByNativeCodeAttribute] Offset: A89C30
  // [NativeHeaderAttribute] Offset: A89C30
  // [NativeConditionalAttribute] Offset: A89C30
  // [NativeHeaderAttribute] Offset: A89C30
  // [StaticAccessorAttribute] Offset: A89C30
  // [NativeHeaderAttribute] Offset: A89C30
