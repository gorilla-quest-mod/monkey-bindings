...
namespace UnityEngine::Networking {
  ...
  // [NativeHeaderAttribute] Offset: AA5CB0
  // [NativeHeaderAttribute] Offset: AA5CB0
  // [UsedByNativeCodeAttribute] Offset: AA5CB0
  class UnityWebRequestAsyncOperation : public ::UnityEngine::AsyncOperation {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xAA5E70
    // [CompilerGeneratedAttribute] Offset: 0xAA5E70
