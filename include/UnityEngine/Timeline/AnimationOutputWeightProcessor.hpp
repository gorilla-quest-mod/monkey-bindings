...
namespace UnityEngine::Timeline {
  ...
  class AnimationOutputWeightProcessor : public ::Il2CppObject/*, public ::UnityEngine::Timeline::ITimelineEvaluateCallback*/ {
    ...
    // Padding between fields: m_Output and: m_Mixers
    char __padding0[0x4] = {};
  ...
  #pragma pack(pop)
  static check_size<sizeof(AnimationOutputWeightProcessor), 32 + sizeof(::System::Collections::Generic::List_1<::UnityEngine::Timeline::AnimationOutputWeightProcessor::WeightInfo>*)> __UnityEngine_Timeline_AnimationOutputWeightProcessorSizeCheck;
  static_assert(sizeof(AnimationOutputWeightProcessor) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
