...
namespace GlobalNamespace {
  ...
  class TeleportAimHandlerParabolic : public ::GlobalNamespace::TeleportAimHandler {
    ...
    public:
    // [TooltipAttribute] Offset: 0xAF28AC
    ...
    // [TooltipAttribute] Offset: 0xAF28E4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xAF291C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xAF2954
    // [RangeAttribute] Offset: 0xAF2954
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xAF29B0
    // [RangeAttribute] Offset: 0xAF29B0
