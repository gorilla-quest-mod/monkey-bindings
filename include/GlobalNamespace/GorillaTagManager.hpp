...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaTagManager), 296 + sizeof(::ArrayW<float>)> __GlobalNamespace_GorillaTagManagerSizeCheck;
  static_assert(sizeof(GorillaTagManager) == 0x130);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
