...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(WardrobeItemButton), 96 + sizeof(::GorillaNetworking::CosmeticsController::CosmeticItem)> __GlobalNamespace_WardrobeItemButtonSizeCheck;
