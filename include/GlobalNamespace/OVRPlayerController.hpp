...
namespace GlobalNamespace {
  ...
  // [RequireComponent] Offset: ACD234
  class OVRPlayerController : public ::UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xAD04BC
    ...
    // [TooltipAttribute] Offset: 0xAD04F4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xAD052C
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // [CompilerGeneratedAttribute] Offset: 0xAD053C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAD054C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAD055C
