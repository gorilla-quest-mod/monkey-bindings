...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaHuntComputer), 112 + sizeof(::GorillaNetworking::CosmeticsController::CosmeticItem)> __GlobalNamespace_GorillaHuntComputerSizeCheck;
