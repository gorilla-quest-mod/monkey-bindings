...
namespace GlobalNamespace {
  ...
  class CharacterCameraConstraint : public ::UnityEngine::MonoBehaviour {
    public:
    public:
    // [TooltipAttribute] Offset: 0xAF235C
    ...
    // [TooltipAttribute] Offset: 0xAF2394
    ...
    // [TooltipAttribute] Offset: 0xAF23CC
    ...
    // [TooltipAttribute] Offset: 0xAF2404
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xAF243C
