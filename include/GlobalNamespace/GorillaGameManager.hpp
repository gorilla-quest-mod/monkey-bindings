...
namespace GlobalNamespace {
  ...
  class GorillaGameManager : public ::Photon::Pun::MonoBehaviourPunCallbacks/*, public ::Photon::Pun::IPunInstantiateMagicCallback*/ {
    ...
    class $$c;
    // Nested type: ::GlobalNamespace::GorillaGameManager::$$c__DisplayClass40_0
    ...
    // static public Photon.Pun.PhotonView StaticFindRigForPlayer(Photon.Realtime.Player player)
    // Offset: 0x1B6C67C
    static ::Photon::Pun::PhotonView* StaticFindRigForPlayer(::Photon::Realtime::Player* player);
    ...
    // private System.Void <Update>b__29_0(PlayFab.ClientModels.GetSharedGroupDataResult result)
    // Offset: 0x1B6CFDC
    void $Update$b__29_0(::PlayFab::ClientModels::GetSharedGroupDataResult* result);
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaGameManager), 168 + sizeof(::ArrayW<::Photon::Realtime::Player*>)> __GlobalNamespace_GorillaGameManagerSizeCheck;
  static_assert(sizeof(GorillaGameManager) == 0xB0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Photon::Pun::PhotonView* (*)(::Photon::Realtime::Player*)>(&GlobalNamespace::GorillaGameManager::StaticFindRigForPlayer)> {
  static const MethodInfo* get() {
    static auto* player = &::il2cpp_utils::GetClassFromName("Photon.Realtime", "Player")->byval_arg;
...
// Writing MetadataGetter for method: GlobalNamespace::GorillaGameManager::$Update$b__29_0
// Il2CppName: <Update>b__29_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GorillaGameManager::*)(::PlayFab::ClientModels::GetSharedGroupDataResult*)>(&GlobalNamespace::GorillaGameManager::$Update$b__29_0)> {
  static const MethodInfo* get() {
    static auto* result = &::il2cpp_utils::GetClassFromName("PlayFab.ClientModels", "GetSharedGroupDataResult")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::GorillaGameManager*), "<Update>b__29_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{result});
  }
};
