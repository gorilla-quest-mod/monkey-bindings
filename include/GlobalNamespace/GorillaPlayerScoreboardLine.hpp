...
namespace GlobalNamespace {
  ...
  class GorillaPlayerScoreboardLine : public ::Photon::Pun::MonoBehaviourPunCallbacks {
    public:
    // Nested type: ::GlobalNamespace::GorillaPlayerScoreboardLine::$UpdateLine$d__30
    class $UpdateLine$d__30;
    ...
    // private System.Void <GetUserLevel>b__33_0(PlayFab.ClientModels.GetUserDataResult result)
    // Offset: 0x1B7D6E0
    void $GetUserLevel$b__33_0(::PlayFab::ClientModels::GetUserDataResult* result);
  }; // GorillaPlayerScoreboardLine
  #pragma pack(pop)
  static check_size<sizeof(GorillaPlayerScoreboardLine), 224 + sizeof(::UnityEngine::GameObject*)> __GlobalNamespace_GorillaPlayerScoreboardLineSizeCheck;
  static_assert(sizeof(GorillaPlayerScoreboardLine) == 0xE8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: GlobalNamespace::GorillaPlayerScoreboardLine::$GetUserLevel$b__33_0
// Il2CppName: <GetUserLevel>b__33_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GorillaPlayerScoreboardLine::*)(::PlayFab::ClientModels::GetUserDataResult*)>(&GlobalNamespace::GorillaPlayerScoreboardLine::$GetUserLevel$b__33_0)> {
  static const MethodInfo* get() {
    static auto* result = &::il2cpp_utils::GetClassFromName("PlayFab.ClientModels", "GetUserDataResult")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::GorillaPlayerScoreboardLine*), "<GetUserLevel>b__33_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{result});
  }
};
