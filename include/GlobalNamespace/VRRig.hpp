...
namespace GlobalNamespace {
  ...
  class VRRig : public ::Photon::Pun::MonoBehaviourPun/*, public ::Photon::Pun::IPunObservable, public ::Photon::Pun::IPunInstantiateMagicCallback*/ {
    public:
    // Nested type: ::GlobalNamespace::VRRig::$OccasionalUpdate$d__86
    class $OccasionalUpdate$d__86;
    ...
    // private System.Void <GetUserCosmeticsAllowed>b__121_0(PlayFab.ClientModels.GetUserInventoryResult result)
    // Offset: 0x1BAF67C
    void $GetUserCosmeticsAllowed$b__121_0(::PlayFab::ClientModels::GetUserInventoryResult* result);
    // private System.Void <GetUserCosmeticsAllowed>b__121_1(PlayFab.PlayFabError error)
    // Offset: 0x1BAF838
    void $GetUserCosmeticsAllowed$b__121_1(::PlayFab::PlayFabError* error);
  }; // VRRig
  #pragma pack(pop)
  static check_size<sizeof(VRRig), 712 + sizeof(::GlobalNamespace::VRRig*)> __GlobalNamespace_VRRigSizeCheck;
  static_assert(sizeof(VRRig) == 0x2D0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: GlobalNamespace::VRRig::$GetUserCosmeticsAllowed$b__121_0
// Il2CppName: <GetUserCosmeticsAllowed>b__121_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::VRRig::*)(::PlayFab::ClientModels::GetUserInventoryResult*)>(&GlobalNamespace::VRRig::$GetUserCosmeticsAllowed$b__121_0)> {
  static const MethodInfo* get() {
    static auto* result = &::il2cpp_utils::GetClassFromName("PlayFab.ClientModels", "GetUserInventoryResult")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::VRRig*), "<GetUserCosmeticsAllowed>b__121_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{result});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::VRRig::$GetUserCosmeticsAllowed$b__121_1
// Il2CppName: <GetUserCosmeticsAllowed>b__121_1
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::VRRig::*)(::PlayFab::PlayFabError*)>(&GlobalNamespace::VRRig::$GetUserCosmeticsAllowed$b__121_1)> {
  static const MethodInfo* get() {
    static auto* error = &::il2cpp_utils::GetClassFromName("PlayFab", "PlayFabError")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::VRRig*), "<GetUserCosmeticsAllowed>b__121_1", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{error});
  }
};
