...
namespace System::Buffers {
  ...
  class DefaultArrayPool_1 : public ::System::Buffers::ArrayPool_1<T> {
    ...
    class Bucket;
    // WARNING Size may be invalid!
    // Autogenerated type: System.Buffers.DefaultArrayPool`1/Bucket
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    // Could not write size check! Type: System.Buffers.DefaultArrayPool`1/Bucket is generic, or has no fields that are valid for size checks!
    public:
    // private readonly System.Buffers.DefaultArrayPool`1/Bucket<T>[] _buckets
    // Size: 0x8
    // Offset: 0x0
    ...
    // Autogenerated instance field getter
    // Get instance field: private readonly System.Buffers.DefaultArrayPool`1/Bucket<T>[] _buckets
