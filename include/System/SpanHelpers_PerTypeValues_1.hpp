...
namespace System {
  ...
  // Autogenerated type: System.SpanHelpers/PerTypeValues`1
  ...
  // Could not write size check! Type: System.SpanHelpers/PerTypeValues`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
