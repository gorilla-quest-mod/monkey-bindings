...
namespace System::Reflection {
  ...
  // [ComDefaultInterfaceAttribute] Offset: A51BEC
  // [ClassInterfaceAttribute] Offset: A51BEC
  // [ComVisibleAttribute] Offset: A51BEC
...
// Writing MetadataGetter for method: System::Reflection::MonoModule::get_FullyQualifiedName
// Il2CppName: get_FullyQualifiedName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Reflection::MonoModule::*)()>(&System::Reflection::MonoModule::get_FullyQualifiedName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Reflection::MonoModule*), "get_FullyQualifiedName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
