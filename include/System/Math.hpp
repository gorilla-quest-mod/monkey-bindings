...
namespace System {
  ...
  class Math : public ::Il2CppObject {
    ...
    // static private System.Int16 AbsHelper(System.Int16 value)
    // Offset: 0x11E1FD8
    static int16_t AbsHelper(int16_t value);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int16_t (*)(int16_t)>(&System::Math::AbsHelper)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Int16")->byval_arg;
