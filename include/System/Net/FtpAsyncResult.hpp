...
namespace System::Net {
  ...
  class FtpAsyncResult : public ::Il2CppObject/*, public ::System::IAsyncResult*/ {
    ...
    // Offset: 0xFE5780
    void set_Response(::System::Net::FtpWebResponse* value);
...
// Writing MetadataGetter for method: System::Net::FtpAsyncResult::set_Response
// Il2CppName: set_Response
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Net::FtpAsyncResult::*)(::System::Net::FtpWebResponse*)>(&System::Net::FtpAsyncResult::set_Response)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System.Net", "FtpWebResponse")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Net::FtpAsyncResult*), "set_Response", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Net::FtpAsyncResult::*)()>(&System::Net::FtpAsyncResult::WaitUntilComplete)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::FtpAsyncResult*), "WaitUntilComplete", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Net::FtpAsyncResult::WaitUntilComplete
// Il2CppName: WaitUntilComplete
...
// Writing MetadataGetter for method: System::Net::FtpAsyncResult::Reset
// Il2CppName: Reset
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Net::FtpAsyncResult::*)()>(&System::Net::FtpAsyncResult::Reset)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::FtpAsyncResult*), "Reset", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
