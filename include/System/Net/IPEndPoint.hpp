...
// Writing MetadataGetter for method: System::Net::IPEndPoint::Snapshot
// Il2CppName: Snapshot
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Net::IPEndPoint* (System::Net::IPEndPoint::*)()>(&System::Net::IPEndPoint::Snapshot)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::IPEndPoint*), "Snapshot", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
