...
// Writing MetadataGetter for method: System::Net::FtpDataStream::get_NetworkStream
// Il2CppName: get_NetworkStream
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IO::Stream* (System::Net::FtpDataStream::*)()>(&System::Net::FtpDataStream::get_NetworkStream)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::FtpDataStream*), "get_NetworkStream", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
