...
namespace Unity::Collections {
  ...
  // [DefaultMemberAttribute] Offset: A67C18
  // [DebuggerTypeProxyAttribute] Offset: A67C18
  // [DebuggerDisplayAttribute] Offset: A67C18
  ...
  struct NativeArray_1/*, public ::System::ValueType, public ::System::IDisposable, public ::System::Collections::Generic::IEnumerable_1<T>, public ::System::IEquatable_1<::Unity::Collections::NativeArray_1<T>>*/ {
    ...
    // static public System.Void Copy(T[] src, System.Int32 srcIndex, Unity.Collections.NativeArray`1<T> dst, System.Int32 dstIndex, System.Int32 length)
    // Offset: 0xFFFFFFFFFFFFFFFF
    static void Copy(::ArrayW<T> src, int srcIndex, ::Unity::Collections::NativeArray_1<T> dst, int dstIndex, int length) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Unity::Collections::NativeArray_1::Copy");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<NativeArray_1<T>>::get(), "Copy", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(src), ::il2cpp_utils::ExtractType(srcIndex), ::il2cpp_utils::ExtractType(dst), ::il2cpp_utils::ExtractType(dstIndex), ::il2cpp_utils::ExtractType(length)})));
      ::il2cpp_utils::RunMethodRethrow<void, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, src, srcIndex, dst, dstIndex, length);
    }
