...
namespace Unity::XR::Oculus::Input {
  ...
  // [InputControlLayoutAttribute] Offset: AB6CA4
  // [PreserveAttribute] Offset: FFFFFFFF
  class OculusRemote : public ::UnityEngine::InputSystem::InputDevice {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xAB9DEC
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAB9DFC
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::InputSystem::Controls::ButtonControl*) == 0x8);
    // [CompilerGeneratedAttribute] Offset: 0xAB9E0C
